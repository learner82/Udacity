...
public class ColorsActivity extends AppCompatActivity {
    ...
    /**
     * This listener gets trigered when the {@link MediaPlayer} has completed
    ...
    /**
     * This listener gets triggered whenever the ausio focus changes
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("mustard yellow","chiwiit┴",R.drawable.color_mustard_yellow,R.raw.color_dusty_yellow));
    ...
    /**
     * Clean up the media player by releashing its resources
     */
